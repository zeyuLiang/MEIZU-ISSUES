...
#   run "RAILS_ENV=#{rails_env} bundle exec #{current_release}/script/delayed_job stop"
#   run "RAILS_ENV=#{rails_env} bundle exec #{current_release}/script/delayed_job -n 2 start"
# end
