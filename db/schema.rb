...
ActiveRecord::Schema.define(:version => 20130416050730) do
  ...
  create_table "member_invitations", :force => true do |t|
    t.integer  "project_id"
    t.string   "mail"
    t.string   "token"
    t.string   "state"
  ...
  add_index "member_invitations", ["inviter_id"], :name => "index_member_invitations_on_inviter_id"
  add_index "member_invitations", ["mail"], :name => "index_member_invitations_on_mail"
  add_index "member_invitations", ["project_id"], :name => "index_member_invitations_on_project_id"
  add_index "member_invitations", ["state"], :name => "index_member_invitations_on_state"
  add_index "member_invitations", ["token"], :name => "index_member_invitations_on_token"
  add_index "member_invitations", ["user_id"], :name => "index_member_invitations_on_user_id"
  ...
  add_index "push_notifications", ["author_id"], :name => "index_push_notifications_on_author_id"
  add_index "push_notifications", ["pusher_id", "pusher_type"], :name => "index_push_notifications_on_pusher_id_and_pusher_type"
  add_index "push_notifications", ["read"], :name => "index_push_notifications_on_read"
  add_index "push_notifications", ["recipient_id"], :name => "index_push_notifications_on_recipient_id"
  add_index "push_notifications", ["type"], :name => "index_push_notifications_on_type"
